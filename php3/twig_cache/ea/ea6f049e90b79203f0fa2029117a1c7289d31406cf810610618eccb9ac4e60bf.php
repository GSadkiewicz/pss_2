...
\t\t\t<input id=\"id_x\" type=\"number\" placeholder=\"Kwota kredytu\" name=\"kwota\" value=\"";
        // line 15
...
\t\t\t<input id=\"id_proc\" type=\"number\" placeholder=\"Na jaki procent\" name=\"procent\" value=\"";
        // line 18
...
\t\t\t<input id=\"id_y\" type=\"number\" placeholder=\"Na ile lat\" name=\"lata\" value=\"";
        // line 21
...
/* */
/* 			<label for="id_x">Kwota kredytu:</label>*/
/* 			<input id="id_x" type="number" placeholder="Kwota kredytu" name="kwota" value="{{kwota}}">*/
/* */
/* 			<label for="id_proc">Na jaki procent:</label>*/
/* 			<input id="id_proc" type="number" placeholder="Na jaki procent" name="procent" value="{{procent}}">*/
/* */
/* 			<label for="id_y">Na ile lat: </label>*/
/* 			<input id="id_y" type="number" placeholder="Na ile lat" name="lata" value="{{lata}}">*/
/* 			*/
/* */
/* 			<button type="submit" class="pure-button">Oblicz ratę</button>*/
/* 		</fieldset>*/
